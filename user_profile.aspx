    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-3 px-1 position-fixed cd3height" style="background-color:#c94c4c" data-spy="affix" data-offset-top="0">
                <!--profile image-->
                <div style="padding: 56px 30px 40px 30px;">
                <asp:Image ID="imgprofileimage" runat="server" Height="300px"  CssClass="img-thumbnail rounded" />
                    </div>
                    ...
                    <section id="about" style="padding:20px">
                        <div style="width: 100%;background-color: white;margin-bottom: 20px;box-shadow: 10px 10px 10px #a6d5a6;">
                            <div style="padding:10px">
                                ...
                                <asp:Button ID="Button1" runat="server" Height="30px" Width="100px" Text="Edit" onclick="Button1_Click"></asp:Button>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <asp:TextBox ID="txtCreatedfor" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <br /> 
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <asp:TextBox ID="txtdrinking" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <br /> 
                                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                               <%-- <asp:Label ID="Label11" runat="server" class="form-control-plaintext" Text="No"></asp:Label>--%>
                                                <asp:TextBox ID="txtsmoking" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <br /> 
                            ...
                            <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                               <%-- <asp:Label ID="Label19" runat="server" class="form-control-plaintext" Text="20 Dec 2018"></asp:Label>--%>
                                                <asp:TextBox ID="txtbirthdate1" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <br /> 
                            ...
                            <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                               <%-- <asp:Label ID="Label23" runat="server" class="form-control-plaintext" Text="Leo"></asp:Label>--%>
                                                <asp:TextBox ID="txtzodiac" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <br /> 
