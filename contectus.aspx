<%@ Page Title="" Language="C#" MasterPageFile="~/user.master" AutoEventWireup="true" CodeFile="contectus.aspx.cs" Inherits="contectus" %>
                        ...
                        <div class="row" style="width: 100%">
                            ...
                            <div class="col-md-6">
                                <div>
                                    ...
                                    <div class="fromtextboxdiv">
                                        <asp:Button ID="btunsend" runat="server" Text="Send" CssClass="btnsend"  />
                                    </div>
                                </div>
                            </div>
                        </div>
